...
class getBaseControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.B8xSpvP'] ?? $container->load('get_ServiceLocator_B8xSpvPService'))->withContext('App\\Controller\\BaseController', $container));
