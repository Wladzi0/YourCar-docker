...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerb513b && ($this->initializerb513b->__invoke($valueHoldere1930, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerb513b) || 1) && $this->valueHoldere1930 = $valueHoldere1930;

        if ($this->valueHoldere1930 === $returnValue = $this->valueHoldere1930->paginate($target, $page, $limit, $options)) {
            return $this;
        }
