...
class getCommentControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.n2gAzJB'] ?? $container->load('get_ServiceLocator_N2gAzJBService'))->withContext('App\\Controller\\CommentController', $container));
