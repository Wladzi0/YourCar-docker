...
class __TwigTemplate_b9f2fb74f23fa32f2a0dfa2f7808a9fd7a722471b2087f1c119b07f9203b04dd extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        ";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 8, $this->source); })()), 'form_start', ["attr" => ["class" => "form-horizontal"]]);
        echo "
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 9, $this->source); })()), "email", [], "any", false, false, false, 9), 'row', ["attr" => ["class" => "form-control", "required" => "true", "placeholder" => "Email"]]);
        // line 12
        echo "
        <div>
            <small>
                ";
        // line 15
        echo "Enter your email address and we we will send you a
        ...
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Send password reset email"), "html", null, true);
        echo "</button>
        ";
        // line 21
...
";
    ...
    {
        return array (  119 => 21,  115 => 20,  109 => 16,  106 => 15,  101 => 12,  99 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"mt-5 container col-3 \">
        ...
        {{ form_start(requestForm, {'attr': {'class': 'form-horizontal'}}) }}
        ...
        <br>
        <button class=\"btn btn-primary\">{{ 'Send password reset email'|trans }}</button>
        {{ form_end(requestForm) }}
    </div>
{% endblock %}", "reset_password/request.html.twig", "/var/www/php/symfony/templates/reset_password/request.html.twig");
    }
}
