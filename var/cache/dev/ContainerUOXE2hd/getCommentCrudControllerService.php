...
class getCommentCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.AJZghCA'] ?? $container->load('get_ServiceLocator_AJZghCAService'))->withContext('App\\Controller\\Admin\\CommentCrudController', $container));
